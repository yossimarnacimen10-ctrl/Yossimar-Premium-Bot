...
def main_menu(show_admin: bool = False):
    ...
    if show_admin:
        rows.append([
            InlineKeyboardButton("🛡️ Menú Administrador", callback_data="admin_panel")
        ])

    return InlineKeyboardMarkup(rows)


def check_result_menu():
    """Teclado para la pantalla de resultado del check Apple."""
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("🔄 Nuevo Check", callback_data="check")],
...
def admin_panel_menu():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🔋 Ver Créditos SICKW", callback_data="sickw_balance")],
